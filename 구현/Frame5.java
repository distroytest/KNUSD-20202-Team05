...
public class Frame extends JFrame {
	...
	JPanel sortPanel6 = new JPanel(); // Ãß°¡,»èÁ¦,¼öÁ¤ Å¬¸¯
...
//-------------------------------------------------------------------------------------------¿©±â±îÁö------------	
		...
		JLabel sortLabel1 = new JLabel("ºÐ·ù");
...
//------------------------------------------------------------------------------------------¿©±â±îÁö-------------------------------					
	...
	class completeMakingSandwichListener implements MouseListener { // »÷µåÀ§Ä¡ ±¸¼º ÇÒ ¶§ ¿Ï·á ¹öÆ°
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (sandwich.breadType == null) {
				System.out.println("»§À» °ñ¶óÁÖ¼¼¿ä");
				check = 0;
			}
			if (sandwich.cheeseType == null) {
				System.out.println("Ä¡Áî¸¦ °ñ¶óÁÖ¼¼¿ä");
				check = 0;
			}
			if (sandwich.toppings.size() == 0) {
				System.out.println("ÅäÇÎÀ» °ñ¶óÁÖ¼¼¿ä");
				check = 0;
			}
			if (sandwich.sauces.size() == 0) {
				System.out.println("¼Ò½º ¹× ½ÃÁî´×À» °ñ¶óÁÖ¼¼¿ä");
				check = 0;
			}
			if (check != 0) {
	...
	public void getSandwichCotentForLabel() { // »÷µåÀ§Ä¡ ³»¿ë UI¿¡ ³ªÅ¸³»´Â ÇÔ¼ö
		...
		JLabel breadSizeContentLabel = new JLabel(""); // »÷µåÀ§Ä¡ ±¸¼ºÇ° Ç¥½ÃÇÒ ¶óº§
		...
		breadSizeContentLabel.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 10));
	...
	public void updateCartContent() {
		...
		for (int i = 0; i < order.sandwichList.size(); i++) {
			...
			addSelectedContentButton.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 8));
			...
			subSelectedContentButton.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
			subSelectedContentButton.addMouseListener(new MouseAdapter() {
				public void mouseClicked(MouseEvent e) {
					...
					if (num1 > 1) {
						...
						System.out.println("´õ ÀÌ»ó ÁÙÀÏ ¼ö ¾ø½À´Ï´Ù");
					}
