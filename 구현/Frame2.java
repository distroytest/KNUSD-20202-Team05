...
public class Frame extends JFrame{
	...
	Breadinfo breadinfo = new Breadinfo();
	//------------------------------------------------------------------------------------------------------
	...
	//---------------------------------------------------
	JPanel cartFramePanel = new JPanel();
	...
	JPanel sortPanel = new JPanel();			// sortPanelÀº ¸®½º³Ê¿¡¼­ ÂüÁ¶¸¦ ¸øÇØ¼­ »ý¼ºÀÚ ÇÔ¼ö¿¡¼­ »©³ÂÀ½
	JPanel sortPanel2 = new JPanel();
	
	//----------------------------------------------------------------------------------------------------------
	// »§, Ä¡Áî, ÅäÇÎ, ¼Ò½º ÆÐ³Î Ãß°¡
				...
				button.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						for(i=0;i<bread.bread.size();i++) {
							...
							button.addMouseListener(new breadClickedMouseListener());
						}
...
//--------------------------------------------------------------------------------------------------------------------------------------
// Ãß°¡·Î ÀÛ¼ºÇÑ ¸¶¿ì½º ¸®½º³Ê
	class sandwichClickedMouseListener implements MouseListener {			// »÷µåÀ§Ä¡ ÆÐ³ÎÀÇ ¹öÆ°ÀÌ Å¬¸¯µÆÀ» ¶§ ¸®½º³Ê
																			// clicked¸¦ µ¡ºÙÀÓ
	...
	class breadClickedMouseListener implements MouseListener{
